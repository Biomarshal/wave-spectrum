    ...
    <AppShell activeView={activeView} onNavigate={setActiveView}>
      <AnimatePresence mode="wait">
        {activeView === 'home' && (
          ...
          >
            <div className="mb-8">
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-[var(--color-text-primary)] mb-2 tracking-tight">
                {greeting}
              </h1>
              <p className="text-sm sm:text-base text-[var(--color-text-secondary)] font-medium tracking-wide">
